        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              <div>
                <div className='flex justify-center items-center gap-34 py-10'>
                  <h5 className="text-lg opacity-50 font-bold">Filters</h5>
                  <FilterListIcon className="size-5 text-gray-400 hover:text-gray-500" />
               </div>
